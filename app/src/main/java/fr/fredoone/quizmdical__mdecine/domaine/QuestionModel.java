...
public class QuestionModel {
    ...
    public QuestionModel(int id, int niveau, String question, String option1, String option2, String option3, String option4, int correctAnsNo, TypeQuestion typeQuestion) {
        this.id = id;
        this.niveau = niveau;
