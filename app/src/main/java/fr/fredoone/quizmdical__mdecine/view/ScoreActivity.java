...
public class ScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String typeQuestion = getIntent().getStringExtra("TYPE_QUESTION");
        ...
        lastScore = preferences.getInt(typeQuestion + "lastScore1", 0);
        Best1 = preferences.getInt(typeQuestion + "Best1", 0);

        lastScore1 = preferences.getInt(typeQuestion + "lastScore2", 0);
        Best2 = preferences.getInt(typeQuestion + "Best2", 0);

        lastScore3 = preferences.getInt(typeQuestion + "lastScore3", 0);
        Best3 = preferences.getInt(typeQuestion + "Best3", 0);

        lastScore4 = preferences.getInt(typeQuestion + "lastScore4", 0);
        Best4 = preferences.getInt(typeQuestion + "Best4", 0);

        lastScore5 = preferences.getInt(typeQuestion + "lastScore5", 0);
        Best5 = preferences.getInt(typeQuestion + "Best5", 0);

        lastScore6 = preferences.getInt(typeQuestion + "lastScore6", 0);
        Best6 = preferences.getInt(typeQuestion + "Best6", 0);

        lastScore7 = preferences.getInt(typeQuestion + "lastScore7", 0);
        Best7 = preferences.getInt(typeQuestion + "Best7", 0);

        lastScore8 = preferences.getInt(typeQuestion + "lastScore8", 0);
        Best8 = preferences.getInt(typeQuestion + "Best8", 0);


        if (lastScore > Best1) {
            Best1 = lastScore;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best1", Best1);
            editor.apply();
        }
        ...
        if (lastScore1 > Best2) {
            Best2 = lastScore1;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best2", Best2);
            editor.apply();
        }
        ...
        if (lastScore3 > Best3) {
            Best3 = lastScore3;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best3", Best3);
            editor.apply();
        }
        ...
        if (lastScore4 > Best4) {
            Best4 = lastScore4;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best4", Best4);
            editor.apply();
        }
        ...
        if (lastScore5 > Best5) {
            Best5 = lastScore5;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best5", Best5);
            editor.apply();
        }
        ...
        if (lastScore6 > Best6) {
            Best6 = lastScore6;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best6", Best6);
            editor.apply();
        }
        ...
        if (lastScore7 > Best7) {
            Best7 = lastScore7;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best7", Best7);
            editor.apply();
        }
        ...
        if (lastScore8 > Best8) {
            Best8 = lastScore8;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(typeQuestion + "Best8", Best8);
            editor.apply();
        }
